...
public final class DataSeeder {
    ...
    public void seedIfEmpty() {
        ...
        Bidder bidder1 = new Bidder(UUID.randomUUID(), now, now, "bidder1", PasswordUtils.hash("bid123"), "Phong Bidder", new BigDecimal("5000000000.00"));
        Bidder bidder2 = new Bidder(UUID.randomUUID(), now, now, "bidder2", PasswordUtils.hash("bid123"), "Tien Bidder", new BigDecimal("8000.00"));
    ...
    private Auction createRunningElectronicsAuction(LocalDateTime now, Seller seller, Bidder bidder) {
        Item item = ItemFactory.create(
                ...
                seller.getId(),
                "MacBook Pro M4",
                "Laptop phục vụ developer, RAM 24GB, SSD 1TB.",
                null,
                new BigDecimal("1500.00"),
                "Apple | Bảo hành 12 tháng"
        );
    ...
    private Auction createOpenArtAuction(LocalDateTime now, Seller seller) {
        Item item = ItemFactory.create(
                ...
                "Tác phẩm sơn dầu chủ đề phố cổ Hà Nội, khung gỗ lim.",
                null,
                new BigDecimal("800.00"),
                "Họa sĩ nội địa | Canvas 80x120"
        );
        return new Auction(
                UUID.randomUUID(),
                now,
    ...
    private Auction createFinishedVehicleAuction(LocalDateTime now, Seller seller, Bidder winner) {
        Item item = ItemFactory.create(
                ...
                seller.getId(),
                "Honda SH 150i 2024",
                "Xe mới 95%, odo 3.500 km, chính chủ.",
                null,
